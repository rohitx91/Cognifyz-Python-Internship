...
2) Create a Python function to reverse the string
3) Display the reversed output
4) Practice Python slicing ([::-1])
...
4) Return and display the reversed value
5) Test with different input strings
